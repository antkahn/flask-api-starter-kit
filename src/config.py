...
POSTGRES = {
    ...
    'host': os.getenv('APPLICATION_POSTGRES_HOST', os.getenv('%s_PORT_5432_TCP_ADDR' % DB_CONTAINER)),
    'port': os.getenv('APPLICATION_POSTGRES_PORT', os.getenv('%s_PORT_5432_TCP_PORT' % DB_CONTAINER)),
